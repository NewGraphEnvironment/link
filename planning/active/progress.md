...
- **Phase 5 — full 3-area run LAUNCHED** (pid 4293): 52 WSGs, zero overlap (Peace 19 / Fraser 24 / Skeena 9). dispatcher=Skeena (smallest, free), cy1=Fraser, cy2=Peace. Burn after consolidate. Log /tmp/fullrun.log.
