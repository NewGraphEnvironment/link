...
Crossing connectivity interpretation for fish passage. The domain layer
between raw crossing data and fresh’s generic network engine — scoring,
overrides, and prioritization.

## Repository Context

**Repository:** NewGraphEnvironment/link **Primary Language:** R
**Prefix:** `lnk_` **Branch:** `main` (v0.7.0 as of 2026-04-23)
